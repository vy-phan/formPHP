                            ...
                            <form action="" method="post">
                                ...
                                <div class="row">
                                    <div class="col-md-12 d-flex justify-content-between">
                                        ...
                                        <button type="submit" class="btn btn-outline-success">
                                            <a href="login.php" class="text-decoration-none text-success btn-success">Login</a>    
                                        </button>
                                    </div>
                                </div>
                                 <br>
                                ...
                                if (isset($_POST['username']) and isset($_POST['password'])) {
                                    ...
                                    if (!empty($username) && !empty($password)) {
                                        ...
                                        if ($userExists) {
                                            echo '<div class="alert alert-danger" role="alert"><strong>Tên đăng nhập đã tồn tại</strong></div>';
                                        } else {
                                            $userValid = false;
                                            ...
                                            if ($userValid) {
                                                echo '<div class="alert alert-danger" role="alert"><strong>Mật khẩu phải tối thiểu 6 ký tự và có số bên trong </strong></div>';   
                                            }else{
                                                $newUser = $username . ',' . $password . PHP_EOL;
                                                file_put_contents($file, $newUser, FILE_APPEND);
                                                echo '<div class="alert alert-success" role="alert"><strong>Đăng kí thành công!</strong></div>';
